...
//
////        long은 명시적으로 L을 붙여 long타입 임을 명시하기도 함.
////        L을 붙이는게 처음에 long타입에 할당한 값을 나중에 재할당할 때 구분을 위해 붙이기도함
//        long l2 = 20L;
//
...
//
////        double -> int 소수를 정수형으로 바꿀 때 소수값이 유실된다.
//        double d2 = 10.5;
//        int i2 = (int)d2;
