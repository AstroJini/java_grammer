...
//        클래스메서드 기본 호출방식: 클래스명.메서드명
        System.out.println(sumAcc(1, 10));///정석적인 호출방식이 아님.
...
//        System.out.println(total1); ///위와 같은 경우도 있음
    }

//    접근제어자(public), 클래스메서드여부(static O) | 객체메서드(static X), 반환타입(int, String, 배열 등), 매개변수(input값)
